...
- Images: `GET {api_base}/images/models` 200 JSON → `POST {api_base}/images` (catalog id, httpx). Otherwise LiteLLM `aimage_generation` (`/v1/images/generations`). No `openrouter/` model prefix; clones stay `openai_compatible`.
