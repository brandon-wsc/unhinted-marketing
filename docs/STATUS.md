...
- **Next (held):** K5 exemplars; **K6** promote-to-org Approvals after org-system cleanup
...
4. **Knowledge (next):** Settings + K1–K2 packs + **`product_matcher`** + **K4 hybrid embeddings** shipped ([docs/knowledge/](./knowledge/)). Next: K5 exemplars. **K6 Approvals held** until org-system cleanup.
