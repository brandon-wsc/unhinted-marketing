...
| Invite accept | Desktop 1440 AuthLayout card: A logged out · B ready · C email mismatch (Alert) · D invalid · **E already in org (409)**. Title + body **inside** the card; actions **bottom-right** (outline left · primary right). Footer **left-aligned** outside. Public preview: invited email + company name ([ADR 0014](../adr/0014-invite-public-preview.md)). |
