...
- **Amended by:** [ADR 0024](./0024-media-storage-local-and-s3.md) — `url` stores an object key (or external/placeholder URL); HTTP/SSE still expose a fetchable `url`; session delete reclaims unreferenced store objects
